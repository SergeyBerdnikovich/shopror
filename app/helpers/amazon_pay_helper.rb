module AmazonPayHelper
  ...
  AMAZON_PAYMENTS_ACCOUNT_ID = 'COANRHXJZCEX3SQ13XSVIBIKNF82TN4ZQC2U9R'

  def amazon_pay_form_tag(options = {}, &block)
    ...
    output.safe_concat(hidden_field_tag('returnUrl', confirm_payment_amazon_url))
